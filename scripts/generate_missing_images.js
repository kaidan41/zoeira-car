...
// Vários prompts possíveis são suportados como array — o script
// escolhe aleatoriamente entre eles a cada tentativa (max 3).
// =============================================================
const PROMPTS = {
  // ── CLASSICOS ──
...
// ── PICOS DE CILADA (Auto Super / CPG) ──
  'jac|t80': [
    '2012 JAC T80 SUV, 2.0 turbo, dark blue metallic, side 3/4 front view, white studio background, photorealistic car photography',
    'JAC T80 compact SUV, 2.0 turbo engine, silver color, 3/4 front angle, isolation on white, photorealistic car photography',
  ],
  'bmw|i3': [
    'BMW i3 electric city car, early model, white or black color, distinctive scissor doors, side 3/4 front view, white studio background, photorealistic car photography',
    'BMW i3 hatchback electric, urban design, minimalist white body, side angle, studio background, photorealistic car photography',
  ],
  'audi|a3': [
    '2014 Audi A3 1.4 TFSI Attraction sedan, silver color, sporty look, side 3/4 front view, white studio background, photorealistic car photography',
    'Audi A3 1.4 TS sedan, premium compact, grey metallic, 3/4 front view, white studio background, photorealistic car photography',
  ],
  'fiat|bravo': [
    '2014 Fiat Bravo 1.8 16V hatchback, red color, classic Italian design, side 3/4 front view, white studio background, photorealistic car photography',
    'Fiat Bravo hatchback, 1.8 engine, silver color, side angle, clean studio background, photorealistic car photography',
  ],
  'mitsubishi|airtrek': [
    'Mitsubishi Airtrek / RVR compact SUV, silver color, angular body, side 3/4 front view, white studio background, photorealistic car photography',
    'Mitsubishi Airtrek SUV, 2.0 engine, dark grey, crossover style, side front angle, white studio background, photorealistic car photography',
  ],
  'maserati|ghibli': [
    'Maserati Ghibli sedan, luxury Italian style, silver or black, long hood, side 3/4 front view, white studio background, photorealistic car photography',
    'Maserati Ghibli luxury sedan, quad exhaust, dark blue metallic, side view, white studio background, photorealistic car photography',
  ],
  'subaru|impreza': [
    'Subaru Impreza WRX hatchback, 2.0 engine, dark blue with orange accents, rally style, 3/4 front view, white studio background, photorealistic car photography',
    'Subaru Impreza WRX sedan, turbo silhouette, white or grey, sporty stance, side 3/4 front view, white studio background, photorealistic car photography',
  ],

  // ── CHINESES RECOMMENDADOS ──
  'byd|dolphin': [
    '2023 BYD Dolphin electric hatchback, blue color, side 3/4 front view, white studio background, photorealistic car photography',
    'BYD Dolphin Plus hatchback, green or white, city car silhouette, front 3/4 view, white studio background, photorealistic car photography',
  ],
  'byd|yuan plus': [
    'BYD Yuan Plus / Atto 3 electric SUV, blue metallic, compact urban SUV shape, side 3/4 view, white studio background, photorealistic car photography',
    'BYD Yuan Plus electric crossover, white body, plump SUV proportions, side front angle, white studio background, photorealistic car photography',
  ],
  'byd|song pro': [
    'BYD Song Pro PHEV SUV, silver color, plug-in hybrid, family SUV shape, side 3/4 front view, white studio background, photorealistic car photography',
    'BYD Song Pro DM-i SUV, grey or red, modern crossover, 3/4 front view, white studio background, photorealistic car photography',
  ],
  'byd|king': [
    '2024 BYD King DM-i sedan, white color, plug-in hybrid, modern sedan shape, side 3/4 front view, white studio background, photorealistic car photography',
    'BYD King sedan, DM-i hybrid, long hood and sleek lines, silver grey, side 3/4 front view, white studio background, photorealistic car photography',
  ],
  'gwm|haval h6': [
    '2023 GWM Haval H6 SUV, white color, family SUV, side 3/4 front view, white studio background, photorealistic car photography',
    'GWM Haval H6 compact SUV, grey or silver, modern body lines, 3/4 front view, white studio background, photorealistic car photography',
  ],
  'gwm|ora 03': [
    'GWM Ora 03 electric hatchback, white or silver, retro-modern design, playful shape, side 3/4 front view, white studio background, photorealistic car photography',
    'ORA 03 EV hatchback, retro-futuristic styling, white body, urban electric car, 3/4 front view, white studio background, photorealistic car photography',
  ],
  'caoa chery|tiggo 7 pro': [
    '2024 Chery Tiggo 7 Pro SUV, white color, family SUV, 1.5 turbo, side 3/4 front view, white studio background, photorealistic car photography',
    'Chery Tiggo 7 Pro SUV, red or silver, modern compact SUV, 3/4 front view, white studio background, photorealistic car photography',
  ],
  'caoa chery|tiggo 8 pro': [
    '2023 Chery Tiggo 8 Pro 7-seater SUV, silver color, 3-row midsize SUV, side 3/4 front view, white studio background, photorealistic car photography',
    'Chery Tiggo 8 Pro 7 seat SUV, grey metallic, long wheelbase SUV, side angle, white studio background, photorealistic car photography',
  ],
  'chery|omoda 5': [
    '2023 Chery Omoda 5 compact SUV, white color, stylized futuristic design, side 3/4 front view, white studio background, photorealistic car photography',
    'Omoda 5 compact SUV, 1.5 turbo, sharp aggressive styling, grey color, 3/4 front view, white studio background, photorealistic car photography',
  ],
  'jac|e-js1': [
    'JAC e-JS1 electric SUV, white color, urban electric compact SUV, sideways 3/4 front view, white studio background, photorealistic car photography',
    'JAC e-JS1 EV subcompact SUV, electric motor, modern body, silver grey, side 3/4 front view, white studio background, photorealistic car photography',
  ],  'jac|e-js4': [
    'JAC e-JS4 electric sedan, white color, modern chassis, side 3/4 front view, white studio background, photorealistic car photography',
    'JAC e-JS4 EV sedan, electric drivetrain, sleek silhouette, grey metallic, 3/4 front view, white studio background, photorealistic car photography',
  ],

  // ── PICADOS PRÉ-EXISTENTES ──
  'volkswagen|tiguan':     ['2022 Volkswagen Tiguan Allspace R-Line SUV, black color, side 3/4 front view, white studio background, photorealistic car photography'],
  'volkswagen|taos':       ['2022 Volkswagen Taos Highline SUV, white color, side 3/4 front view, white studio background, photorealistic car photography'],
  'chevrolet|tracker':     ['2022 Chevrolet Tracker Premier Turbo compact SUV, white color, side 3/4 front view, white studio background, photorealistic car photography'],
  'chevrolet|equinox':     ['2022 Chevrolet Equinox Premier SUV, silver color, side 3/4 front view, white studio background, photorealistic car photography'],
...
// =============================================================
// Filtra veículos sem imagem LOCAL ou com URL externa (Wikimedia =
...
// =============================================================
// Retry helper: backoff exponencial + jitter
// Só retenta em rate limit (429/TooManyRequests) ou erro de rede transitório.
// =============================================================
async function sleep(ms) {
  return new Promise(resolve => setTimeout(resolve, ms));
}

function jitter(baseMs, jitterRatio = 0.25) {
  const variation = Math.floor(baseMs * jitterRatio * (2 * Math.random() - 1));
  return baseMs + variation;
}

async function fetchWithRetry(url, { maxAttempts = 4, baseDelayMs = 8000, rateLimitDelayMs = 45000 } = {}) {
  let lastErr = null;
  ...
  for (let attempt = 1; attempt <= maxAttempts; attempt++) {
    try {
      ...
      // Rate limit explícito: backoff mais longo e retenta
      if (res.status === 429) {
        const waitMs = attempt === maxAttempts ? rateLimitDelayMs : jitter(baseDelayMs * 2, 0.3);
        console.log(`    HTTP ${res.status} (rate limit). Tenta ${attempt}/${maxAttempts} — waiting ${Math.round(waitMs / 1000)}s`);
        await sleep(Math.min(waitMs, rateLimitDelayMs));
        continue;
      }

      // Erros 5xx transitórios: retenta com backoff leve
      if (res.status >= 500) {
        const waitMs = jitter(baseDelayMs, 0.4);
        console.log(`    HTTP ${res.status}. Tenta ${attempt}/${maxAttempts} — waiting ${Math.round(waitMs / 1000)}s`);
        await sleep(Math.min(waitMs, rateLimitDelayMs));
        continue;
      }

      // Qualquer outroHTTP não-200: não faz sentido retentar cegamente
      if (!res.ok) {
        const bodyPreview = await res.text().catch(() => '');
        throw new Error(`HTTP ${res.status} ${res.statusText} — ${bodyPreview.slice(0, 200)}`);
      }
      ...
      // Erro de rede DNS/TLS/timeout: retenta com backoff leve
      const isNetworkish = /fetch failed|DNS|network|ECONN|ETIMEDOUT|timed? out/i.test(String(err?.message ?? ''));
      if (isNetworkish && attempt < maxAttempts) {
        const waitMs = jitter(baseDelayMs, 0.4);
        console.log(`    Rede/Erro transitório: ${err.message}. Tenta ${attempt}/${maxAttempts} — waiting ${Math.round(waitMs / 1000)}s`);
        await sleep(Math.min(waitMs, rateLimitDelayMs));
        continue;
      }

      // Erro “limite de requisições da API de IA” (ex: Upstage, caso caia no fetch)
      const isRateLimitByMessage = /too_many_requests|rate limit|request limit|reached your api request limit/i.test(String(err?.message ?? ''));
      if (isRateLimitByMessage && attempt < maxAttempts) {
        const waitMs = attempt === maxAttempts ? rateLimitDelayMs : jitter(baseDelayMs * 3, 0.4);
        console.log(`    Limite de API: ${err.message}. Tenta ${attempt}/${maxAttempts} — waiting ${Math.round(waitMs / 1000)}s`);
        await sleep(Math.min(waitMs, rateLimitDelayMs));
        continue;
      }

      // Falha não-recuperável: encerra retry
      throw err;
    }
  }

  throw lastErr ?? new Error('fetchWithRetry: sem erro capturado');
}

// =============================================================
// Gera 1 imagem com retry inteligente
// =============================================================
async function genOne(v) {
  ...
  const promptList = Array.isArray(getPrompt(v.brand, v.model, v.version))
    ? getPrompt(v.brand, v.model, v.version)
    : [getPrompt(v.brand, v.model, v.version)];

  const chosenPrompt = promptList[Math.floor(Math.random() * promptList.length)];
  console.log(`  Gerando: ${v.brand} ${v.model}...`);
  console.log(`  Prompt: ${chosenPrompt.substring(0, 80)}...`);

  const seed = Math.floor(Math.random() * 1000000);
  const url  = `https://image.pollinations.ai/prompt/${encodeURIComponent(chosenPrompt)}?width=1024&height=768&model=flux&seed=${seed}&nologo=true`;

  let res;
  try {
    res = await fetchWithRetry(url, { maxAttempts: 4, baseDelayMs: 6000, rateLimitDelayMs: 45000 });
  } catch (err) {
    console.log(`    Falhou após retries: ${err.message}`);
    return null;
  }

  const buf = Buffer.from(await res.arrayBuffer());

  // Pollinations às vezes devolve página de erro pequena — tratamos como falha
  if (buf.length < 10000) {
    console.log(`    Imagem muito pequena (${(buf.length / 1024).toFixed(1)}KB) — provável erro/rate limit. Pulando.`);
    return null;
  }
  ...
  // Pausa entre imagens geradas com sucesso para não embolar a API do lote seguinte
...
(async () => {
  ...
  console.log(`\n${ok}/${batch.length} imagens geradas. ${fail} falhou. Total em disco: ${fs.readdirSync(OUT_DIR).length}`);
  console.log('Para continuar o lote, rode novamente com BATCH=... ou aumente o limite de tentativas.\n');
})();
